...
- **PreToolUse/PostToolUse hooks don't fire from plugins** — upstream Claude Code bug ([#6305](https://github.com/anthropics/claude-code/issues/6305)). Our hook definitions are correct; SessionStart hooks work fine. Track the issue for updates.
