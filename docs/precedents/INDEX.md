...
| [BC-5826](BC-5826.md) | Split semantic operator-intent gate from per-iteration turn-structure prompts for N-chunk mutating ops; BC-2707 preserved without gate fatigue | pattern-choice | 2026-04-20 | pattern-choice, gate-fatigue, turn-structure, bc-2707, mcp-orchestration |
