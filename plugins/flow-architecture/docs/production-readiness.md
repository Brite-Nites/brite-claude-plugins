...
- [x] [BC-9028][bc-9028] — P3 `/flow:office-hours` Q42 free-text interview mismatched the `AskUserQuestion` multi-choice shape. Fixed via **Q42 amendment 1** (free-text-via-Other shape; recorded in [`fda-plugin-interview.md` § Q42 amendment 1][interview]). **PR #326 → plugin 1.0.7.**
- [x] [BC-9971][bc-9971] — `/flow:add-domain` could not re-scaffold an inventory-only domain (Q20.4 hard-reject gap). Fixed via **Q20 amendment 1** (inventory-only-domain re-scaffold branch; recorded in [`fda-plugin-interview.md` § Q20 amendment 1][interview]). **PR #327 → plugin 1.0.8.**
...
- [x] **Q57 lock transcribed** verbatim into [`design-rationale/fda-plugin-interview.md` § Q57][interview] (scope deferral: /flow:deprecate-legacy → v1.2; ship v1.1 on bug-cohort + dogfood; no feature requirement). Schema-discipline amendment pattern applied.
...
[interview]: design-rationale/fda-plugin-interview.md
