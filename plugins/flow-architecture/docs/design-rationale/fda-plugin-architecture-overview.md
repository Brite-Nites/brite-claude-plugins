...
3. [The Architecture — FDA Plugin v1](#3-the-architecture)
   ...
   - 3h. [Quality Gate Stack (37 gates post-Q29 amendment 6)](#3h-quality-gate-stack)
...
Per Q29 lock + Q29 amendment 6 (LOCKED 2026-06-26 per BC-13935) — **37 gates** across 3 categories:

```
   QUALITY GATE STACK (Q29 + amendment 6) — 37 gates total
   ═══════════════════════════════════════════════════════════
   ...
   │  retrofit-cross-reference-complete (R), bootstrap-complete │
   │                                                            │
...
| Q   | Topic                            | Lock summary                                                             |
|-----|----------------------------------|--------------------------------------------------------------------------|
| Q29 | Quality-gate stack enumeration   | 37 gates post-Q29 amendment 6 (9 phase-transition + 22 per-flow + 6 cross-cutting incl. `journey-front-matter-populated` + `cross-domain-deps-bidirectional`); 3-section report; Override flow per Q29.5 |
...
10. **Quality gate stack** (§3h) — 9 + 22 + 6 = 37 gates post-Q29 amendment 6 + audit runner
...
Q29  Quality-gate stack enumeration              — 37 gates post-amendment 6 (9+22+6)
...
Q38  /flow:audit shape                           — 7 sub-decisions; 37-gate runner (post-Q29 amendment 6)
