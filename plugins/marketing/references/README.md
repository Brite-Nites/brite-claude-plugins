...
- `email-copywriting` preset composition (e.g., BC-5932 zoos) — `vertical-playbooks/<vertical>.md` § Offer candidates + § V1 offer picks + § Voice rules + § Anti-slop rules
