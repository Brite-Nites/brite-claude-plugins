...
| [blitz-api](integrations/blitz-api.md) | Owner discovery + enrichment primary — tam-map step 6 primary (Python CLI, no MCP) | Ported BC-5946 |
| [prospeo](integrations/prospeo.md) | LinkedIn → email + mobile fallback — tam-map step 6 fallback (Python CLI, no MCP) | Ported BC-5946 |
