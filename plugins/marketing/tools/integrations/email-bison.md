...
- **Bulk lead import:** `bulk_create` accepts **500 leads per call** ([WIP §6 Q6](../../../../docs/research/outbound-pipeline-findings.md#6-open-design-questions)). Skills doing larger imports must chunk.
